...
extern tr1::unordered_map<string,ED2DTuple<int,5,3> > position_map; // 'ar','1','2','3','am' -> start_pos,start_bin,end_bin
...
extern tr1::unordered_map<string,ED2DTuple<int,3,3> > angle_position_map; // sp,sp2,sp3 -> start_pos,start_bin,end_bin
...
class EDAccess {
private:
    static tr1::unordered_map<string,ED2DTuple<int,5,3> >::const_iterator last_questioned;
    static tr1::unordered_map<string,ED2DTuple<int,3,3> >::const_iterator angle_last_questioned;
